...
export function SummaryCards({ violations }: Props) {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
      <div className="bg-[#1a1f2e] border-2 border-orange-500 rounded-lg p-6">
        <div className="flex items-center justify-between">
          <div>
            <div className="text-gray-400 text-xs uppercase tracking-wide mb-2">Open Violations</div>
            <div className="text-5xl font-bold text-white mb-2">{openCount}</div>
            <div className="text-gray-400 text-sm">Active cases requiring attention</div>
          </div>
          <div className="w-16 h-16 bg-gray-800 rounded-full flex items-center justify-center">
            <svg className="w-9 h-9 text-orange-500" fill="currentColor" viewBox="0 0 20 20">
