...
async function fetchViolations(sheetId: string): Promise<ViolationsData> {
  console.log('Fetching violations for sheetId:', sheetId)
  ...
  if (!response.ok) {
    ...
    console.error('Failed to fetch violations:', errorText)
    throw new Error('Failed to fetch violations: ' + errorText)
  }
