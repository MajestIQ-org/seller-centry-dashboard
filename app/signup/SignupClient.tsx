...
export default function SignupClient() {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      // Ensure we have an authenticated session before calling accept-invite.
      // If email confirmation is enabled, this signIn may fail until confirmed.
      ...
      <div className="w-full max-w-md">
        <form onSubmit={handleSubmit} className="bg-gray-800 rounded-lg p-8 space-y-6">
          <div>
            ...
            <p className="text-gray-400 text-sm">Join Seller Centry Dashboard</p>
          </div>
          ...
          {inviteData?.merchantId ? null : null}
        </form>
      </div>
    </div>
  )
