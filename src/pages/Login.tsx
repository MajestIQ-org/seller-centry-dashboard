  ...
  return (
    <div className="min-h-screen bg-gray-900 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <form onSubmit={showForgotPassword ? handleForgotPassword : handleSubmit} className="bg-gray-800 rounded-lg p-8 space-y-6">
          <div>
            <h1 className="text-2xl font-bold text-white mb-2">
              {showForgotPassword ? 'Reset Password' : 'Sign In'}
            </h1>
            <p className="text-gray-400 text-sm">
              {showForgotPassword ? 'Enter your email to receive a reset link' : 'Access your account health dashboard'}
            </p>
          </div>
          ...
          {!showForgotPassword && (
            <>
              ...
              <button
                ...
                disabled={loading}
                className="w-full bg-white hover:bg-gray-100 text-gray-900 font-medium py-3 rounded-lg transition-colors disabled:opacity-50 flex items-center justify-center gap-3 min-h-[48px]"
              >
